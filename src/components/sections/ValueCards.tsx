...
const PILLARS = [
  {
    ...
    body: "Learn without limits. UeCampus delivers online learning that fits around your lifestyle.",
    accent: "ember" as const,
  },
  {
    n: "02",
    title: "A global qualification, without leaving home.",
    body: "Earn international recognition with partner institutions in the UK, France, Malta, and the USA, without uprooting your life.",
