...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="container-wide flex items-center justify-end py-2 text-[11px] font-mono uppercase tracking-[0.18em] text-ink-mute">
          <span className="flex items-center gap-5">
            <a href="mailto:info@uecampus.com" className="hover:text-plum transition-snap">
              info@uecampus.com
            </a>
            <span aria-hidden className="h-3 w-px bg-rule" />
            <a href="tel:+447747312812" className="hover:text-plum transition-snap">
              +44 7747 312812
            </a>
          </span>
        </div>
