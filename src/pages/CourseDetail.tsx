...
const TABS = [
  ...
  { id: "academics",  label: "Units/Modules" },
      ...
      <section className="bg-paper pt-10 md:pt-14 pb-14 md:pb-20 border-b border-rule">
        ...
        <div className="container-wide grid lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          <div className="lg:col-span-7">
            ...
            <h1 className="mt-5 font-serif text-[36px] md:text-[44px] lg:text-[52px] leading-[1.08] tracking-[-0.02em] text-ink">
        ...
        <div className="container-wide grid gap-12 lg:grid-cols-[1fr_320px]">
          <div className="min-w-0">
            ...
            {tab === "payment" && (
              <div className="space-y-14">
                <div>
                  <Eyebrow number="01">Payment plans</Eyebrow>
                  <h2 className="mt-4 font-serif text-display-sm text-ink">
                    Flexible ways to pay.
                  </h2>
                  <p className="mt-6 font-serif text-[17px] leading-[1.7] text-ink-soft max-w-prose">
                    We keep tuition manageable. Choose to pay in full or spread
                    the cost across instalments — annually, semi-annually,
                    quarterly, or monthly — with employer sponsorship supported
                    where available. Our admissions team will confirm the exact
                    options and amounts for the {course.title}.
                  </p>
                  <ul className="mt-10 grid sm:grid-cols-2 border-t border-rule">
                    {paymentPlans.map((p, i) => (
                      ...
                      >
                        ...
                        <p className="mt-2 text-[14px] text-ink-mute leading-relaxed">{p.desc}</p>
                      </li>
                    ))}
                  </ul>
                </div>
                ...
                <div>
                  <Eyebrow number="02">Tuition</Eyebrow>
                  <h3 className="mt-4 font-serif text-[28px] text-ink">What it costs.</h3>
                  <div className="mt-6 flex flex-wrap items-center gap-4">
                    <span className="inline-flex items-center gap-2 border border-rule px-4 py-2 text-[14px] text-ink">
                      <Clock className="h-3.5 w-3.5 text-plum" /> Tuition · {course.tuition}
                    </span>
                    <Link to="/contact-us" className="group inline-flex items-center gap-2 font-serif text-[16px] text-ink">
                      <span className="link-editorial">Talk to admissions about payment</span>
